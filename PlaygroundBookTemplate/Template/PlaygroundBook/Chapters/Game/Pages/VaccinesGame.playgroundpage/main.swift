...
/// sets the number of virusesStored Within Infected Cells on the display (you can change this)
gameScene.setNumberOfVirusesStoredInInfectedCells(numberOfVirusesStoredInInfectedCells: /*#-editable-code*/ 15 /*#-end-editable-code*/)
...
///allows player to shoot Antibodies
gameScene.setPlayerAllowedToShoot()
